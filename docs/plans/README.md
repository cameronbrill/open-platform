...
Testing and validation work belongs in plans when it changes sequencing, deliverables, or milestone exit criteria. Durable testing policy belongs in [ADRs](../adr/README.md) and [Specs](../specs/README.md). Repo tooling and automation rollout belongs primarily in [Repo Foundations](01-repo-foundations.md) and later validation plans.
...
| [Repo Foundations](01-repo-foundations.md) | draft | repo skeleton, tooling foundations, CI automation, and docs conventions |
