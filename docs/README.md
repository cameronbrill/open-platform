...
| [ADR-0002: Secret Bootstrap and 1Password Integration](adr/0002-secret-bootstrap-and-1password-integration.md) | accepted | historical 1Password-backed secret bootstrap decision |
